...
rm -rf openwrt/feeds/luci/applications/luci-app-smartdns -rf
...
rm -rf openwrt/feeds/packages/net/mosdns -rf
rm -rf openwrt/feeds/luci/applications/luci-app-mosdns -rf
